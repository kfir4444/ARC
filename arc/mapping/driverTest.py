...
class TestMapping(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        """
        cls.maxDiff = None
        cls.db_path = rmg_settings['database.directory']
        #cls.rmgdb = make_rmg_database_object()
        cls.rmgdb = RMGDatabase()
        cls.rmgdb.load(path=cls.db_path,
    ...
    def test_map_abstractions(self):
        ...
        self.assertEqual(len(atom_map), len(unique(atom_map)))
        self.assertTrue(check_atom_map(rxn))
        ...
        self.assertTrue(check_atom_map(rxn1))
    ...
    def test_map_ho2_elimination_from_peroxy_radical(self):
        ...
        self.assertIn(atom_map[4:6], [[10, 9], [9, 10]])
        ...
        atom_map = rxn_2.atom_map
        self.assertEqual(atom_map[:4], [0, 1, 2, 3])
        self.assertIn(atom_map[4:6], [[9, 10], [10, 9]])
        self.assertIn(atom_map[6:8], [[4, 5], [5, 4]])
        self.assertEqual(atom_map[8], 6)
        self.assertEqual(atom_map[9], 11)
        self.assertIn(atom_map[10:], [[8, 7], [7, 8]])
        ...
        atom_map = rxn_2.atom_map
        self.assertEqual(atom_map[:4], [3, 4, 5, 6])
        self.assertIn(atom_map[4:6], [[0, 1], [1, 0]])
        self.assertIn(atom_map[6:8], [[7, 8], [8, 7]])
        self.assertEqual(atom_map[8], 9)
        self.assertEqual(atom_map[9], 2)
        self.assertIn(atom_map[10:], [[10, 11], [11, 10]])
        ...
        self.assertIn(rxn_4.atom_map[3:5], [[7, 8], [8, 7]])
        ...
        rxn_5.determine_family(self.rmgdb)
        self.assertEqual(rxn_5.atom_map[:3], [0, 1, 2])
        self.assertIn(tuple(rxn_5.atom_map[3:6]), list(permutations([5, 6, 7], 3)))
        self.assertEqual(rxn_5.atom_map[6], 8)
        self.assertIn(rxn_5.atom_map[7:9], [[3, 4], [4, 3]])
        ...
        self.assertIn(rxn_6.atom_map[:2], [[3, 4], [4, 3]])
        self.assertEqual(rxn_6.atom_map[2:6], [9, 0, 1, 2])
        self.assertIn(tuple(rxn_6.atom_map[6:9]), list(permutations([5, 6, 7], 3)))
